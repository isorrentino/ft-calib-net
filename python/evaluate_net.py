...
if __name__ == "__main__":
    ...
    with h5py.File("../datasets/2022_09_22_test_dataset.mat", "r") as file:
        # dataset["ang_vel"] = (
        ...
        dataset["ft_temperature"] = np.array(np.array(file["dataset"][part]["ft_temperature"])
                                         - scaling[part]["ft_temperature"]["mean"]
                                 ) / (scaling[part]["ft_temperature"]["std"])
    ...
    b, a = butter(2, 0.0005, btype='low', analog=False)
